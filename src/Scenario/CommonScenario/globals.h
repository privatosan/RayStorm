 ...
 *    16.08.99 ah    added hyper texture sampling parameters
 ***************/
...
class GLOBALS
{
	public:
		...
		ULONG hyper_samples;          // ray samples
		float hyper_min_dens;         // minimum delta density
		float hyper_max_dens;         // maximum delta density
