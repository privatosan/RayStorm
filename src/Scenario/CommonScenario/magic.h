...
#define MAGIC_H
	...
	#define ALIGN_VIEWER_VELOC    0.2f     // align velocity of viewer
	#define MOVE_VIEWER_VELOC     0.001f   // move velocity of viewer
	#define MOVE_OBJECT_VELOC     0.001f   // move velocity of object
	#define ALIGN_OBJECT_VELOC    0.5f     // align velocity of object
	#define SCALE_OBJECT_VELOC    0.01f    // scale velocity of object
	#define SCALE_OBJECT_VELOC2   0.02f    // scale velocity of object (variant)
	...
	#define CURSOR_MOVE           0.25f    // movement with cursor in orthogonal views
	...
	#define ALIGN_VIEWER_VELOC    0.1f
	#define MOVE_VIEWER_VELOC     0.001f
	#define MOVE_OBJECT_VELOC     0.001f
	#define ALIGN_OBJECT_VELOC    0.2f
	#define SCALE_OBJECT_VELOC    0.01f
	#define SCALE_OBJECT_VELOC2   0.02f
	#define SCALE_MOUSE_DELTA     1.5f
	#define SUBDIV                10
	...
	#define PLANE_DIVS            5
	#define CURSOR_MOVE           0.25f
	#define ZOOM_INOUT            1.5f
