 ...
 *    10.05.99 ah    added brush mapping coordinates support
 ***************/
...
typedef struct tOBJLINK
{
	...
	BOOL        (*TriangleUV)(rsiCONTEXT*, TRIANGLE *, VECT2D *,VECT2D *,VECT2D *);
	...
	OBJECT*     (*MeshAddRenderer)(rsiCONTEXT*, SURFACE*, SURFACE**, ACTOR*, VECTOR*, int, LINK_EDGE*, int, LINK_MESH*, int, VECTOR*, VECTOR*, VECTOR*, VECTOR*, VECTOR*, BOOL);
