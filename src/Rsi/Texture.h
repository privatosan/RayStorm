...
class TEXTURE : public SLIST
{
	public:
		...
		virtual void Apply(VECTOR *, SURFACE *, const VECTOR *, RAY *) { };
		virtual void Apply(VECTOR *, SURFACE *, const VECTOR *, RAY *, float*, float, COLOR*) { };
...
class HYPER_TEXTURE : public TEXTURE
{
	public:
		...
		~HYPER_TEXTURE();
		int Load(RSICONTEXT*, char*, char*);
		void Apply(VECTOR *, SURFACE *, const VECTOR *, RAY *, float*, float, COLOR*);
		TEXTURE *Duplicate();
};
