...
#define rsiFCameraHiddenArea  2
#define rsiFCameraAccelerate  4
...
rsiResult rsiAddHyperTexture(rsiCONTEXT*, void **, char *, void *);
...
enum tags
{
	...
	rsiTWorldMinObjects,
	rsiTWorldHyperSteps,
	rsiTWorldHyperMinDeltaDens,
	rsiTWorldHyperMaxDeltaDens,
	rsiTCameraPos,
	rsiTCameraLook,
	rsiTCameraViewUp,
	rsiTCameraPosActor,
