 ...
 *************/
extern "C" void SAVEDS texture_cleanup(MARBLE_INFO *tinfo)
{
 ...
 * OUTPUT:        -
 *************/
extern "C" void SAVEDS texture_work(MARBLE_INFO *info, DIALOG_DATA *params, TEXTURE_PATCH *patch, VECTOR *v)
{
	float val, one_minus_val;

	val = Turbulence(v, params->octaves, info->hashTable);
