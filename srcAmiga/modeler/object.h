...
// flags
#define OBJECT_DIRTY                0x00001     // object has been selected and is now unselected and reverse
#define OBJECT_NODEOPEN             0x00002     // browser node is open
#define OBJECT_OPENTOP              0x00004     // open top cap (cylinder and sor)
#define OBJECT_OPENBOTTOM           0x00008     // open bottom cap (cylinder, cone and sor)
#define OBJECT_INVERTED             0x00010     // object is inverted (needed for CSG)
#define OBJECT_NOPHONG              0x00020     // disable phong shading (mesh)
#define OBJECT_APPLYSURF            0x00040     // apply surface to child objects (only for external objects) (mesh)
#define OBJECT_HANDLEDIRTY          0x00080     // remove dirty handles from screen (mesh and SOR)
#define OBJECT_MESHEDITING          0x00100     // set while a mesh or points object is edited
#define OBJECT_SOR_ACCURATE         0x00200     // use accurate but slow algorithm for sor

#define OBJECT_LIGHT_SHADOW         0x00800     // casts shadows
#define OBJECT_LIGHT_FLARES         0x01000     // has flares
#define OBJECT_LIGHT_STAR           0x02000     // has star
#define OBJECT_LIGHT_SHADOWMAP      0x04000     // has shadowmap
#define OBJECT_LIGHT_TRACKFALLOFF   0x08000     // takes fall off form track distance

#define OBJECT_CAMERA_VFOV          0x10000     // take VFOV from resolution
#define OBJECT_CAMERA_FOCUSTRACK    0x20000     // set focal distance to track distance
#define OBJECT_CAMERA_FASTDOF       0x40000     // apply fast depth of field

#define OBJECT_HANDLEDIRTY1         0x80000     // draw dirty handles screen (mesh and SOR)
